...
async def _(event):
    ...
    lionevent = await edit_or_reply(event, "`wi8..! I am searching your lyrics....`")
    ...
    if event.pattern_match.group(1):
        ...
        return await lionevent.edit("`What I am Supposed to find `")
    song = ""
    ...
    await edit_or_reply(lionevent, reply)
