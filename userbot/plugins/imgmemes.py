...
# credits to @Copyless786 (@Simpleboy785)
import asyncio
import os
import re
...
@lionub.lion_cmd(
    ...
    info={
        ...
        "examples": "{tr}fakegs Lion-Z ; One of the Popular userbot",
    },
)
...
@lionub.lion_cmd(
    ...
    info={
        ...
        "usage": "{tr}trump <text>",
        "examples": "{tr}trump Lion-Z is One of the Popular userbot",
    },
)
async def nekobot(lion):
...
@lionub.lion_cmd(
    ...
    info={
        ...
        "usage": "{tr}modi <text>",
        "examples": "{tr}modi Lion-Z is One of the Popular userbot",
    },
)
async def nekobot(lion):
...
@lionub.lion_cmd(
    ...
    info={
        ...
        "usage": "{tr}cmm <text>",
        "examples": "{tr}cmm Lion-Z is One of the Popular userbot",
    },
)
async def nekobot(lion):
    text = lion.pattern_match.group(1)
...
@lionub.lion_cmd(
    ...
    info={
        ...
        "usage": "{tr}kanna text",
        "examples": "{tr}kanna Lion-Z is One of the Popular userbot",
    },
)
async def nekobot(lion):
...
@lionub.lion_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; Lion-Z is One of the Popular userbot",
    },
)
async def nekobot(lion):
