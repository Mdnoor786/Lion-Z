...
async def fetch_fedinfo(event):
    ...
    async with event.client.conversation(rose) as conv:
        try:
            ...
            await edit_delete(
                lionevent,
                "**Error while fetching fedinfo:**\n__Unblock__ @MissRose_Bot __and try again!__",
                10,
            )
        except Exception as e:
            await edit_delete(
                lionevent, f"**Error while fetching fedinfo:**\n__{str(e)}__", 10
            )
...
async def myfeds_fedinfo(event):
    ...
    async with event.client.conversation(rose) as conv:
        try:
            ...
            await edit_delete(
                lionevent,
                "**Error while fetching myfeds:**\n__Unblock__ @MissRose_Bot __and try again!__",
                10,
            )
        except Exception as e:
            await edit_delete(
                lionevent, f"**Error while fetching myfeds:**\n__{str(e)}__", 10
            )
        await event.client.send_read_acknowledge(conv.chat_id)
        conv.cancel()
...
async def fstat_rose(event):
    ...
    async with event.client.conversation(rose) as conv:
        try:
            ...
            await edit_delete(
                lionevent,
                "**Error while fetching fedstat:**\n__Unblock__ @MissRose_Bot __and try again!__",
                10,
            )
        except Exception as e:
            await edit_delete(
                lionevent, f"**Error while fetching fedstat:**\n__{str(e)}__", 10
            )
        await event.client.send_read_acknowledge(conv.chat_id)
        conv.cancel()