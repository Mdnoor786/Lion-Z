...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/MdNoor786/Lion-Z.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Lion-Z")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/270e8f7b9b7fd41c19991.jpg"
    )
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-Lion-Z-01-01
